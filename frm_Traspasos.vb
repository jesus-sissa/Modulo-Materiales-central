Public Class frm_Traspasos
    ...
    Private Sub frm_Traspasos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Lsv_Datos.Columns.Add("ControlFolios") 'Id_InventarioDestino
        Lsv_Datos.Columns.Add("Folios") 'Descripcion de Material en la Sucursal Destino
        Lsv_Datos.HeaderStyle = ColumnHeaderStyle.Nonclickable
        Lsv_Datos.Columns(2).TextAlign = HorizontalAlignment.Right
        'FuncionesGlobales.fn_Columna(Lsv_Datos, 15, 50, 15, 15, 15, 15, 15, 0, 0, 0)


        cmb_Material.AgregaParametro("@Tipo", 4, 1)
        cmb_Material.AgregaParametro("@Status", "A", 4)
    ...
    Private Sub btn_Guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Guardar.Click
        ...
        For Each lsvItem In Lsv_Datos.Items()
            ...
            Dr_Local("Control_Folios") = lsvItem.SubItems(5).Text
            Dr_Local("Folios") = lsvItem.SubItems(6).Text
