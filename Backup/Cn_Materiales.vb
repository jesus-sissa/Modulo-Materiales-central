...
#Region "Funciones Compartidas"
    ...
    Public Shared Function fn_LlenarLista(ByVal Procedure As String, ByVal Indice As String, ByVal Lista As cp_Listview, _
                                          ByVal Sucursal As Boolean, Optional ByVal Tipo As Integer = 0, _
...
#Region "Ventas de Materiales"
    ...
    Public Shared Function fn_VentasMateriales_Guardar(ByVal Id_Cliente As Integer, ByVal Id_Departamento As Integer, _
    ByVal Fecha_Entrega As Date, ByVal Interno As String, ByVal dt As DataTable, ByVal Control_Folios As String)
    ...
    Public Shared Function fn_VentasMateriales_Nuevo(ByVal Id_Cliente As Integer, ByVal Id_Departamento As Integer, _
...
#Region "Comprar Materiales"
    ...
    Public Shared Function fn_ComprasMateriales_Guardar(ByVal lsv As cp_Listview, ByVal Tipo_Orden As Byte, ByVal Id_Proveedor As Integer, ByVal AtencionA As String, ByVal Importe As Decimal, ByVal IVA As Decimal, ByVal Total As Decimal, ByVal Observaciones As String, ByVal Id_Moneda As Integer, ByVal Domicilio_Entrega As String, ByVal Condiciones_Pago As String) As Long
...
#Region "CONSUMIBLES"
    ...
    End Function
    '--------------------------------------------------------
    Public Shared Function fn_SurtirSolicitudConsumibles_Guardar(ByVal Id_Solicitud As Integer, ByVal Dt As DataTable) As Boolean
        Dim Cnn As SqlConnection = Crea_ConexionSTD()
        Dim Tr As SqlTransaction = crear_Trans(Cnn)
        Dim Cmd As SqlCommand
        Try
    ...
    End Function
    '---------------------------------------------
    Public Shared Function fn_ValidarSolicitudesConsumibles_LlenarLista(ByVal lsv As cp_Listview, ByVal UsuarioSolicita As Integer) As Boolean
...
#Region "Proveedores"
    ...
    Public Shared Function fn_Proveedores_Nuevo(ByVal Clave As String, ByVal NombreF As String, ByVal DireccionF As String, ByVal Numero_Fiscal As Integer, ByVal NumeroInt_Fiscal As String, ByVal Colonia_Fiscal As String, ByVal CiudadF As Integer, _
        ByVal RFC As String, ByVal NombreC As String, ByVal DireccionC As String, ByVal Numero_Comercial As Integer, ByVal NumeroInt_Comercial As String, ByVal Colonia_Comercial As String, ByVal CiudadC As Integer, ByVal Contacto As String, ByVal Telefono As String, _
    ...
    Public Shared Function fn_Proveedores_Actualizar(ByVal Id_Proveedor As Integer, ByVal Clave As String, ByVal NombreF As String, ByVal DireccionF As String, ByVal Numero_Fiscal As Integer, ByVal NumeroInt_Fiscal As String, ByVal Colonia_Fiscal As String, ByVal CiudadF As Integer, _
        ByVal RFC As String, ByVal NombreC As String, ByVal DireccionC As String, ByVal Numero_Comercial As Integer, ByVal NumeroInt_Comercial As String, ByVal Colonia_Comercial As String, ByVal CiudadC As Integer, ByVal Contacto As String, ByVal Telefono As String, _
...
#Region "Traspasos Intersucursales"
    ...
    Public Shared Function fn_TraspasosMateriales_Guardar(ByVal Clave_SucursalO As String, ByVal Nombre_SucursalO As String, ByVal Clave_SucursalD As String, _
