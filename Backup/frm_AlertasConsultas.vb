Imports Modulo_MaterialesCentral.Cn_Fallas
...
Public Class frm_AlertasConsultas
    ...
    Private Sub btn_Mostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Mostrar.Click
        ...
        lbl_Total.Text = "Registros: " & lsv_Alertas.Items.Count.ToString
        btn_Exportar.Enabled = lsv_Alertas.Items.Count > 0
    End Sub
    ...
    Private Sub btn_Exportar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Exportar.Click
        ...
        Cn_Login.fn_Log_Create("EXPORTAR REPORTE CONSULTA DE ALERTAS GENERADAS. FECHAS: " & dtp_Desde.Value.ToShortDateString & " - " & dtp_Hasta.Value.ToShortDateString & " / TIPO: " & cmb_Tipo.Text & " / STATUS: " & cmb_Status.Text)
    End Sub
