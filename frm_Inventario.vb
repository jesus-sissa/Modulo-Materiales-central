...
Public Class frm_Inventario
    ...
    Sub LlenarLista()
        ...
        Cn_Materiales.fn_InventarioMateriales_LlenarLista(lsv_Catalogo, 4)
    ...
    Private Sub BTN_Modificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTN_Modificar.Click, lsv_Catalogo.DoubleClick
        ...
        If CadenaPermisosControles.IndexOf("MODIFICAR") <> -1 Then
        ...
        Else
            MsgBox("No se puede editar el material.", MsgBoxStyle.Critical, frm_MENU.Text)
        End If
