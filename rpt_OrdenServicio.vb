...
Public Class rpt_OrdenServicio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_MaterialesCentral.rpt_OrdenServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_OrdenServicio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_OrdenServicio = New rpt_OrdenServicio()
        rpt.Site = Me.Site
        Return rpt
    End Function
